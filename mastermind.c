...
// mastermind guessing game.  Pick four numbers.  If number right and in right spot then 
// you get a red indicator.  If correct number but wrong spot then you get a white
//indicator.  Otherwise, no matches.
...
void guess_the_number(char *secret_number)
//Guess the number that was randomly generated by computer.
{
	char c; 		
	char my_number[5];
